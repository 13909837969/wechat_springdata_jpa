	...
	<form id="form"  method="post">
		...
		<div>
		     <div style="padding-right:20px;padding-left:20px">
				...
				<input type="text" name="name" id="name"  placeholder="请输入您的真实姓名" class="required font-blue input-lightblue">
		     </div>
			...
			<div style="padding-right:20px;padding-left:20px">
		    	...
		    	<input type="text" name="cellphone" id="cellphone"  placeholder="请输入您的手机号" class="required isPhone font-blue input-lightblue" >
	    ...
	    <div style="padding-right:20px;padding-left:20px;padding-top:20px;">
	    	<input id="updateBtn" type="button" value="更新"  style="padding:10px;background: #e57330;text-shadow: none;opacity:100;color:white;font-size:20px;text-indent:0px;font-family:微软雅黑;" >
	    </div>
	</form>
</div>
</div>
