 ...
 */
	...
	private static Menu getMenu() {
		...
		btn10.setName("会议发布");
		btn10.setType("view");
		btn10.setUrl(MenuManager.REAL_URL+"weixin/oauth?flag=10");
		
		ViewButton btn11 = new ViewButton();
		btn11.setName("会议抢单");
		btn11.setType("view");
		btn11.setUrl(MenuManager.REAL_URL+"weixin/oauth?flag=11");
...
//------------------------------------------------------------	
		...
		btn31.setName("个人中心");
		btn31.setType("view");
		btn31.setUrl(MenuManager.REAL_URL+"weixin/oauth?flag=31");
